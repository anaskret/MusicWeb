using MusicWeb.Services.Extensions;
using System;
...
namespace MusicWeb.Services.Services.Identity
{
    public class PasswordGeneratorService
    {
        ...
        public PasswordGeneratorService(int minimumLengthPassword = 8, int maximumLengthPassword = 15, int minimumLowerCaseChars = 1,
